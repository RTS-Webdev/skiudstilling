...
export default function FadingImage() {
    ...
    return (
        <article className="relative w-full min-h-[calc(100vh-15vh)] flex flex-col items-center">
            <div className="w-full max-w-[70%] mx-auto">
                <figure className="relative aspect-[16/9] mb-8">
                ...
                <div className="space-y-8 pb-16 pt-8">
                    <section className="space-y-4">
                        <h2 className="text-3xl font-bold">Din specialist i skirejser</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-3xl font-bold">Sammen skaber vi jeres skieventyr</h2>
                        <p className="text-lg leading-relaxed">
